...
// To ensure we can see any potential errors
if (!file_exists($_SERVER['DOCUMENT_ROOT'] . '/sistem/config/database.php')) {
    die('Database configuration file not found');
}
if (!file_exists($_SERVER['DOCUMENT_ROOT'] . '/sistem/classes/Book.php')) {
    die('Book class file not found');
}
?>
<!DOCTYPE html>
<html lang="id">
...
<body class="bg-gray-50 min-h-screen">
    <?php include $_SERVER['DOCUMENT_ROOT'] . '/sistem/petugas/includes/navigation.php'; ?>
